...
const UpgradePlanFallback = () => (
  <div>
    <h2 className="text-2xl font-bold">Upgrade to Access Client Management</h2>
    <p className="text-muted-foreground my-4">
      Managing clients is only available on plans with the CRM feature.
    </p>
    <Button asChild>
...
export default function ClientsPage() {
  ...
  return (
    <div>
      ...
      <Protect feature="basic_crm" fallback={<UpgradePlanFallback />}>
        <Card>
          <CardHeader>
